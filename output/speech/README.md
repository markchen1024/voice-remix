...
- Speed: `1.0`
- Total generated narration: **130.1 seconds**
...
| `03-voice-intro.wav` | 5.05s | Lead-in before the live Talk request |
| `04-after-live-request.wav` | 5.15s | Realtime transcription explanation after the live request |
